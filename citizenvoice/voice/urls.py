...
router.register(
    r"polygonfeatures", views.PolygonFeatureViewSet, basename="polygonfeature"
)
router.register(r"linefeatures", views.LineFeatureViewSet, basename="linefeature")
router.register(r"map-views", views.MapViewViewSet, basename="mapview")
router.register(r"pointfeatures", views.PointFeatureViewSet, basename="pointfeature")
